...
async function login(email, password) {
    ...
    try {
        const response = await fetch("https://m12-test-render-backend.onrender.com//backend/public/index.php?action=login", {
            method: 'POST',
...
async function createUser(username, email, password) {
    try {
        const res = await fetch("https://m12-test-render-backend.onrender.com//backend/public/index.php?action=register", {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function checkSession() {
    try {
        const res = await fetch("https://m12-test-render-backend.onrender.com//backend/public/index.php?action=checkSession", {
            method: 'GET',
            credentials: 'include',
...
async function logout() {
    ...
    if (session.logged) {
        try {
            const res = await fetch("https://m12-test-render-backend.onrender.com//backend/public/index.php?action=logout", {
                method: 'POST',
                credentials: 'include'
            });
