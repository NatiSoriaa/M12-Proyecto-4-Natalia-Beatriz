...
/* index.html.twig */
class __TwigTemplate_7be4a6a110d05ad588acfb4c8da27e5092394007f353fc0b9108c1a90fa6ca4d extends Template
{
...
<body>
    ...
    ";
        ...
        ";
            ...
            // line 17
            yield "            <a href=\"/M12-Proyecto-4-Natalia-Beatriz/backend/public/index.php?action=logout\">
                Tancar la sessió
...
<body>
    ...
    {% if session.usuari_id %}  <!-- Verifica si hay un usuario en sesión -->
        ...
        {% endif %}
            <a href=\"/M12-Proyecto-4-Natalia-Beatriz/backend/public/index.php?action=logout\">
                Tancar la sessió
            </a>  <!-- Enlace para cerrar sesión -->
    {% else %}
...
", "index.html.twig", "C:\\xampp\\htdocs\\M12-Proyecto-4-Natalia-Beatriz\\backend\\views\\index.html.twig");
    }
}
